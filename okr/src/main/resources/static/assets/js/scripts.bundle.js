...
KTUtil.ready(function() {
    ...
    KTLayoutQuickActions.init('kt_notification');

    // Init Quick Notifications Offcanvas Panel
    KTLayoutQuickNotifications.init('kt_quick_notifications');

    // Init Quick Offcanvas Panel
    KTLayoutQuickPanel.init('kt_setting_panel');

    // Init Quick User Panel
    KTLayoutQuickUser.init('kt_user_profile');
...
var KTLayoutQuickActions = function() {
    ...
    var _init = function() {
        ...
        _offcanvasObject = new KTOffcanvas(_element, {
            ...
            baseClass: 'offcanvas',
            placement: 'right',
            closeBy: 'kt_notification_close',
            toggleBy: 'kt_notification_toggle'
        });
...
var KTLayoutQuickPanel = function() {
    ...
    var _initLogs = function() {
        KTUtil.scrollInit(_companyElement, {
            mobileNativeScroll: true,
            resetHeightOnDestroy: true,
            handleWindowResize: true,
            height: function() {
    ...
    var _initSettings = function() {
        KTUtil.scrollInit(_assessmentElement, {
            mobileNativeScroll: true,
            resetHeightOnDestroy: true,
            handleWindowResize: true,
            height: function() {
    ...
    var _updateScrollbars = function() {
        $(_element).find('a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
            KTUtil.scrollUpdate(_okrElement);
            KTUtil.scrollUpdate(_companyElement);
            KTUtil.scrollUpdate(_assessmentElement);
        });
    }
    ...
    return {
        init: function(id) {
            _element = KTUtil.getById(id);
            _okrElement = KTUtil.getById('kt_tab_okr');
            _companyElement = KTUtil.getById('kt_tab_company');
            _assessmentElement = KTUtil.getById('kt_tab_assessment');
...
var KTLayoutQuickUser = function() {
    ...
    var _init = function() {
        ...
        _offcanvasObject = new KTOffcanvas(_element, {
            ...
            baseClass: 'offcanvas',
            placement: 'right',
            closeBy: 'kt_user_profile_close',
            toggleBy: 'kt_user_profile_toggle'
        });
